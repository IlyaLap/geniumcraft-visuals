...
const blogPosts = [
  {
    ...
    excerpt: 'Практические советы и стратегии для значительного повышения конверсии вашего веб-сайта в короткие сроки.',
  ...
  {
    id: 2,
    title: 'SEO-оптимизация в 2023 году: что работает, а что нет',
    excerpt: 'Последние тренды и изменения в алгоритмах поисковых систем, которые влияют на ранжирование вашего сайта.',
  ...
  },
  {
    ...
    excerpt: 'Научный подход к выбору цветовой палитры для вашего сайта, чтобы влиять на решения пользователей.',
  ...
  {
    id: 4,
    title: 'Мобильная оптимизация: почему это критически важно в 2023 году',
    excerpt: 'Как адаптировать ваш сайт для мобильных устройств и почему это может быть решающим фактором для успеха.',
