            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-12">
              <div className="glass-card p-8 rounded-xl">
                <article className="prose prose-invert max-w-none">
                  ...
                  <h2>Почему цвета имеют значение</h2>
                  ...
                  <h3>Синий — доверие и безопасность</h3>
                  <p>
                  ...
                  <h3>Красный — срочность и энергия</h3>
                  <p>
                  ...
                  <h3>Фиолетовый — креативность и роскошь</h3>
                  <p>
                  ...
                  <h2>Практические рекомендации по выбору цветов</h2>
                  
                  <h3>1. Учитывайте свою целевую аудиторию</h3>
                  <p>
                  ...
                  <h3>2. Следуйте правилу 60-30-10</h3>
                  <p>
                  ...
                  <h3>3. Тестируйте разные варианты</h3>
                  <p>
